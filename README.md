...
|-- README.md                         # Portfolio landing page and evidence map
|-- Assets/
|   `-- google-developer-profile-badges.png
|-- Module-1-Android-Basics/
|   |-- README.md                     # Unit 1 guide
|   |-- Analysis.md
|   |-- Badge-Evidence/               # Three pathway screenshots
|   |-- Screenshots/                  # Unit completion
|   `-- Source-Code/                  # Complete Android Studio project
|-- Module-2-Jetpack-Compose/
|   |-- README.md                     # Unit 2 guide
|   |-- Analysis.md
|   |-- Badge-Evidence/
|   |-- Screenshots/
|   `-- Source-Code/                  # Selected Compose implementation
|-- Module-3-Lists-Material-Design/
|   |-- README.md                     # Unit 3 guide
|   |-- Analysis.md
|   |-- Badge-Evidence/
|   |-- Screenshots/
|   `-- Source-Code/                  # Source availability note
|-- Module-4-Navigation-App-Architecture/
|   |-- README.md                     # Unit 4 guide
|   |-- Analysis.md
|   |-- Badge-Evidence/
|   |-- Screenshots/
|   `-- Source-Code/                  # Selected state sample
|-- Reflection/
|   `-- Reflection.md
`-- References/
    `-- References.md
